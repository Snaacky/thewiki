...
- [Redacted](https://redacted.ch/) - Commonly referred to as RED, it's the best source for music, has everything in both FLAC and MP3. It's a private tracker, meaning you'll have to go through an [IRC Interview to join](https://interviewfor.red/en/index.html). Thoroughly read the interview page.
...
- [Jpopsuki](https://jpopsuki.eu/) - Asian music private tracker with extremely easy economy but lacks quality control. Only way to join this is via invites on other private trackers.

!!!warning
Do not under any circumstances ask people to invite you. This is forbidden by private trackers and can lead your accounts to be permanently disabled. Trading/buying invites is also forbidden and will get you disabled/blacklisted across all private trackers.
!!!
